...
mixin _$ThemeStore on ThemeStoreBase, Store {
  ...
  Brightness get brightness =>
      (_$brightnessComputed ??= Computed<Brightness>(() => super.brightness,
              name: 'ThemeStoreBase.brightness'))
          .value;
  ...
  SystemUiOverlayStyle get colorStatus => (_$colorStatusComputed ??=
          Computed<SystemUiOverlayStyle>(() => super.colorStatus,
              name: 'ThemeStoreBase.colorStatus'))
      .value;

  late final _$_themeModeAtom =
      Atom(name: 'ThemeStoreBase._themeMode', context: context);
  ...
  late final _$_brightnessAtom =
      Atom(name: 'ThemeStoreBase._brightness', context: context);
  ...
  late final _$errorMessageAtom =
      Atom(name: 'ThemeStoreBase.errorMessage', context: context);
  ...
  late final _$toggleThemeModeAsyncAction =
      AsyncAction('ThemeStoreBase.toggleThemeMode', context: context);
  ...
  void setBrightness(Brightness? brightness) {
    final _$actionInfo = _$ThemeStoreBaseActionController.startAction(
        name: 'ThemeStoreBase.setBrightness');
    try {
